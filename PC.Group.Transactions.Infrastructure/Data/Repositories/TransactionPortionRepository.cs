...
public class TransactionPortionRepository : BaseRepository<TransactionPortion>, ITransactionPortionRepository
{
    public TransactionPortionRepository(TransactionContext transactionContext) : base(transactionContext)
    { }
}
